...
<div class="container ">
<div class="row d-flex justify-content-lg-center align-lg-items justify-content-md-center align-md-items ms-5 gap-md-5 gap-lg-0">
<div class=" col-12  col-lg-6  col-md-3 ">
<div class=" ">
<img src="/logo1.png" alt="logo" class="img-fluid  " style="width:170px"></div>
<p>© 2023 WALIDELHAMZAOUI
<br>
    ALL RIGHTS RESERVED</p>
</div>
<ul class="nav col-12 col-lg-6  col-md-6  d-flex flex-column  mt-5   ">

<h4 class=" ms-lg-5 ps-lg-5 mb-4 text-capitalize fw-bolder">contact us</h4>
    <li class="mb-2 w-100" ><a href="tel:0639433495" class="btn text-white p-2 px-5 " style="background-color: #008000;width:300px;overflow: hidden" >Telephone</a></li>
    <li><div class="sd me-5">
